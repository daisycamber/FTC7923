...
void turn902(bool direction)
{
	...
	if(direction)
	{
		...
		motor[right] = 40;
		wait1Msec(80);
		while(currHeading < 70 || currHeading > 350)
		{
			nxtDisplayBigStringAt(25, 25,"%d",currHeading);
			wait1Msec(10);
		}
	...
	else
	{
		...
		motor[right] = -40;
		wait1Msec(80);
		while(currHeading > 291 || currHeading < 10)
		{
			nxtDisplayBigStringAt(25, 25,"%d",currHeading);
			wait1Msec(10);
		}
...
void turn9022(bool direction)
{
	...
	else
	{
		...
		motor[right] = -40;
		wait1Msec(80);///////////
		while(currHeading > 284 || currHeading < 10)
		{
			nxtDisplayBigStringAt(25, 25,"%d",currHeading);
			wait1Msec(10);
		}
...
void turn901(bool direction)
{
	...
	if(direction)
	{
		...
		motor[right] = 40;
		wait1Msec(80);
		while(currHeading < 77 || currHeading > 350)
		{
			nxtDisplayBigStringAt(25, 25,"%d",currHeading);
			wait1Msec(10);
		}
	...
	else
	{
		...
		motor[right] = -40;
		wait1Msec(80);
		while(currHeading > 295 || currHeading < 20)
		{
			nxtDisplayBigStringAt(25, 25,"%d",currHeading);
			wait1Msec(10);
		}
...
void autonomous2()
{
	...
	// go forward to tube
	forward(4000,-5);
	forward(1200,-4); // go back to 2 if needed
